...
include $(CHIBIOS)/os/various/pico_bindings/pico-bootloader.mk
include $(CHIBIOS)/os/various/pico_bindings/pico-uf2.mk
...
UDEFS = -DCRT0_VTOR_INIT=1 -DCRT0_EXTRA_CORES_NUMBER=1 -DPICO_NO_FPGA_CHECK \
-DNDEBUG
